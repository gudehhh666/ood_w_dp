...
dataset_options = ['cifar10', 'cifar100', 'tiny-imagenet', 'tiny-imagenet-noisy']
...
parser.add_argument('--save-freq', '-s', default=25, type=int, metavar='N', help='save frequency')
...
methods = ['baseline', 'infobatch', 'infobatch_grad'] # 'infobatch'
...
if args.dataset == 'cifar10':
    ...
    root = {'train': '/root/tiny-imagenet/train',
            'test': '/root/tiny-imagenet/valid'}
    noisy_root = {'data': '/root/tiny-img-noisy/tiny_img_noisy_2.npy',
                  'target': '/root/tiny-img-noisy/tiny_target_noisy_2.npy'}
    test_loader, testset = get_tiny(root, True, True, args.batch_size, **kwargs)
    train_loader, trainset = get_tiny_mislabel(noisy_root, return_set=True, batch_size=args.batch_size, **kwargs)
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_loss, train_acc, train_time = train(model, device, train_loader, optimizer)
        ...
        metrics_data = {
                ...
                'num_cut': trainset.get_pruned_count() if args.method != 'baseline' else 0
                } 
        if args.state =='train':
        ...
        if test_accuracy > acc_best and epoch > 30:
