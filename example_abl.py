...
parser.add_argument('--method', type=str, default='EL2N_abl', help='method')
...
if args.model_dir =='':
    model_dir = os.path.join(model_dir, f'{args.method}_r{args.rate}', args.mod)
else:
...
if args.dataset == 'cifar10':
    ...
    if args.method == 'infobatch':
        ...
        if args.method in ['EL2N', 'loss', 'EL2N_abl']:
            ...
            loss_dir = None
        trainset = CIFAR100_loss_ablation(root=data_dir, train=True, download=True, transform=transform_train, loss_dir=loss_dir, cut_rate=args.rate, mod=args.mod)
        # trainset = torchvision.datasets.CIFAR10(root=data_dir, train=True, download=True, transform=transform_test)
