...
from data.cifar_noisy import CIFAR100Noisy
...
dataset_options = ['cifar10', 'cifar100-noisy', 'tiny-imagenet']
...
parser.add_argument('--dataset', '-d', default='cifar100-noisy', choices=dataset_options)
...
parser.add_argument('--model-dir', default='./checkpoint/res50-cifar100-noisy/infobatch/', help='directory of model for saving checkpoint')
# parser.add_argument()
...
if args.dataset == 'cifar10':
    ...
    if args.method == 'infobatch' or args.method == 'infobatch_grad' or args.method == 'infobatch_grad':
        trainset =CIFAR100Noisy(root=data_dir, train=True, download=True, transform=transform_train)
